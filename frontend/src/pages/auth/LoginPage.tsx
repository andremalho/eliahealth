...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left panel — branding */}
      <div className="hidden lg:flex lg:w-[40%] flex-col items-center justify-center bg-cream relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute top-20 left-10 w-48 h-48 rounded-full bg-rose/10" />
        <div className="absolute bottom-32 right-8 w-64 h-64 rounded-full bg-teal/10" />
        <div className="absolute top-1/2 left-1/3 w-32 h-32 rounded-full bg-primary/10" />
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-sm text-sand-dark tracking-widest uppercase">
            Prontuario Pre-natal
          </p>
          <p className="mt-8 text-lg text-rose-dark/70 leading-relaxed max-w-xs mx-auto">
            Prontuario pre-natal inteligente para obstetras e suas pacientes
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-10">
            ...
            <p className="text-xs text-sand-dark tracking-widest uppercase mt-1">
              Prontuario Pre-natal
            </p>
          </div>
